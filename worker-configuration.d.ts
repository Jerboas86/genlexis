/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cc6203979ddc201b081aa81ccab35234)
// Runtime types generated with workerd@1.20260521.1 2026-04-28 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ORIGIN: "https://stg.genlexis.com" | "https://genlexis.com";
	PRIVATE_DATABASE_URL: string;
	BETTER_AUTH_SECRET: string;
	PRIVATE_MATERIAL_API_TOKEN: string;
	PRIVATE_MATERIAL_SIGNING_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "PRIVATE_DATABASE_URL" | "BETTER_AUTH_SECRET" | "PRIVATE_MATERIAL_API_TOKEN" | "PRIVATE_MATERIAL_SIGNING_SECRET">> {}
}
