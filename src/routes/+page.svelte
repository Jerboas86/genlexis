...
<style>
	.shell {
		...
		margin: 0 auto;
		padding: var(--space-hero) 0 var(--space-section-lg);
	}
	...
	.coral {
		background:
			radial-gradient(circle at 80% 10%, rgba(255, 255, 255, 0.28), transparent 34%),
	...
	@media (max-width: 700px) {
		.shell {
			width: min(100% - var(--space-xxl), var(--container));
